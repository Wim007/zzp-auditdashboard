    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 text-sm text-blue-800">
          ...
          Het planningssysteem APM kan een niet-compliant CZO technisch niet inroosteren. Een actieve status hier betekent per definitie volledige compliance op dit moment.
        </div>
