  ...
  return (
    <div className="relative">
      <button
        onClick={() => setOpen((o) => !o)}
        disabled={bezig}
        className="flex items-center gap-2 bg-primary hover:bg-primary-dark disabled:opacity-50 text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors"
      >
